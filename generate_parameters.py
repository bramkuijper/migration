...
socially_sensitive_mortality = [0, 0.2, 0.4, 0.6, 0.8, 1]  # Default would be 0, where the mortality rate is indepdendent of flock size
evolutionary_equilibrising_time = 1000000
K_decline_factor = [1]
autumn_harvest = [0, 0.1, 0.5, 0.9]
